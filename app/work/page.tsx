...
const allProjects = [
  ...
  },
  {
    ...
    description: "ScanMBG is a web app that enables users to scan, upload images of, or manually input details from Indonesia's Makan Bergizi Gratis (MBG) food trays. Powered by Gemini 2.5 Flash (with Qwen 3.5 fallback) for precise image recognition, portion estimation, pricing, and nutritional analysis cross-referenced against the TKPI database, it delivers a 0-10 health score, AI-generated summaries, detailed nutritional breakdowns, and interactive graphs for protein, fats, calories, and macros to promote informed, healthier dining choices.",
    tech: ["Javascript", "Next.js", "Tailwind CSS"],
    github: "https://github.com/gnatnib/scanmbg",
    liveDemo: "https://scanmbg.vercel.app/",
  },
  {
    ...
    year: "2025",
    images: ["/zonakhas.png"],
    description: "A community service project for Kelurahan Sendangmulyo to strengthen the ZONA KHAS program for UMKM and Pangan Lokal. Built using Next.js, Tailwind CSS, and Typescript.",
